  ...
  return (
    <div className="mapa">
      ...
      <div className="area">
        ...
        <div className="seccion" onClick={() => handleSectionClick("Sección 21")}> Sección 21 </div>
        <div className="seccion" onClick={() => handleSectionClick("Sección 22")}> Sección 22 </div>
        <div className="seccion" onClick={() => handleSectionClick("Sección 23")}> Sección 23 </div>
        <div className="seccion" onClick={() => handleSectionClick("Sección 24")}> Sección 24 </div>
      </div>
    </div>
  );
};
